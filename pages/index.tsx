...
export default function Home({ name }: IProps) {
  return (
    <div className="md:px-32 xl:px-40 px-4  flex flex-col bg-gradient-to-tr from-grad via-grad2 to-grad items-center justify-center min-h-screen py-2">
      <div className="w-full h-full my-32 md:flex-row  flex flex-col items-center justify-around align-middle">
        <div className="text-white  mx-4">
          <span className="flex items-start align-middle "><p className="md:text-2xl text-3xl my-4">Bonjour !</p><img className="w-11 mx-4 wave" src="img/main.png" alt="" /></span>
          <h1 className="md:text-2xl xl:text-4xl text-4xl my-4">
            JE SUIS <span className="text-blue  font-bold">JULIEN ABBADIE</span>
          </h1>
          <div className="typewriter text-left">
            <h2 className="md:text-xl xl:text-2xl text-xl my-4">
            Développeur
